...
def preprocessing(car_no):
    image = cv2.imread("/Users/a1/Downloads/source/chap12/images/car/%02d.jpg" %car_no, cv2.IMREAD_COLOR)
...
svm = cv2.ml.SVM_load("/Users/a1/Downloads/source/chap12/SVMtrain.xml")                  # 학습된 데이터 적재
...
K1, K2 = 10, 10
nknn = kNN_train("/Users/a1/Downloads/source/chap12/images/train_numbers.png", K1, 10, 20) # 숫자 학습
tknn = kNN_train("/Users/a1/Downloads/source/chap12/images/train_texts.png", K2, 40, 20)   # 문자 학습
